...
const putPublications = require('../../lib/populate/upload-publications')
...
exports.handler = async (event) => {
  ...
  const response = await fetch(`https://pub.orcid.org/v3.0/${context.publisherId}/works`, {
    method: 'GET',
    headers: {
  ...
  const result = await putPublications(payload, context)
